...
-- TAMBAHAN LOCAL RULES 
	{ name = 'SYN-Scan-Attempt', priority = 2,
	  text = 'Percobaan Scanning TCP Half scan/full scan' },

	{ name = 'Xmas-Scan', priority = 1,
	  text = 'Mendeteksi Scanning (Evading Firewall) dengan metode XMAS flags FPU' },

	{ name = 'FIN-Scan', priority = 1,
	  text = 'Mendeteksi Scanning (Evading Firewall) dengan metode FIN flags F' },

	{ name = 'NULL-Scan', priority = 1,
	  text = 'Mendeteksi Aktivitas Flags 0, Percobaan Scanning (Evading Firewall) metode NULL' },

	{ name = 'UDP-Scan-Traffic', priority = 2, 
	  text = 'Aktivitas Mencurigakan UDP, percobaan scanning proto UDP' },

	{ name = 'misc-SSH-activity', priority = 1,
	  text = 'Traffic SSH, Percobaan Brute force service ssh' },

	{ name = 'misc-VNC-activity', priority = 1,
	  text = 'Traffic VNC, percobaan brute force login VNC' },
	
	{ name = 'misc-FTP-activity', priority = 1,
          text = 'Traffic FTP, percobaan brute force login service FTP' },

	{ name = 'icmp-flood-traffic', priority = 2,
          text = 'Mendeteksi traffic DoS menggunakan proto ICMP | indikasi flood > 1000 paket' },

	{ name = 'ack-flood-traffic', priority = 1,
          text = 'Mendeteksi traffic flood ACK Flags | indikasi flood > 1000 paket' },

	{ name = 'ftp-flood-dos', priority = 1,
          text = 'Mendeteksi traffic DOS ke service port FTP' },

	{ name = 'dos-traffic-attempt', priority = 1,
          text = 'Mendeteksi traffic flood DoS | indikasi flood > 1000 paket' },

	{ name = 'syn-flood-traffic', priority = 1,
	  text = 'Mendeteksi trafic DoS SYN Flags | indikasi flood > 1000 paket' },

	{ name = 'UDP-Port-Netbios', priority = 2,
          text = 'Mendeteksi scan port ke Netbios Server' },

	{ name = 'UDP-Port-NTP', priority = 2,
          text = 'Mendeteksi scan port ke NTP Server' },

	{ name = 'udp-flood-traffic', priority = 2,
          text = 'Mendeteksi DoS protokol UDP | indikasi flood > 1000 paket' }
}
