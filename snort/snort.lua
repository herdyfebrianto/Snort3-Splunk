...
appid =
{
    ...
    --app_detector_dir = '/usr/local/bin',
}
...
event_filter =
{
    ...
    { sid = 1000654, type = 'both', track = 'by_src', count = 1000, seconds = 30 },
    { sid = 1000014, type = 'both', track = 'by_src', count = 1000, seconds = 30 },
    { sid = 1000017, type = 'threshold', track = 'by_src', count = 1000, seconds = 30 },
    { sid = 1000016, type = 'threshold', track = 'by_src', count = 1000, seconds = 30 },
    { sid = 1000504, type = 'threshold', track = 'by_src', count = 1000, seconds = 30 },
...
alert_json = 
{
	file = true,
	limit = 100,
	fields = 'timestamp rule gid src_addr src_port proto dst_addr dst_port msg class priority tcp_flags service action iface tcp_len udp_len',
}
...
alert_log = 
{
	file = true,
	limit = 100,
	fields = 'timestamp sid rev gid rule src_addr src_port proto dst_addr dst_port msg class priority tcp_flags service action iface tcp_len udp_len',
	
--fields = 'timestamp sid rev rule src_addr src_port proto dst_addr dst_port msg class priority tcp_flags iface gid pkt_len service',
